...
int get_1st_weekday(int year)//formula for the first day
{
    int d;
    d = (((year - 1) * 365) + ((year - 1) / 4) - ((year - 1) / 100) + ((year) / 400) + 1) % 7;
    return d;
}
void print_year_calender()//year module
{
...
void print_month_calender()//month module
{
    int month1;
    printf("\n\n*************** MONTH CALENDAR ***************");
...
int main()
{
    system("Color 3F");//for the background colo                 r to change
